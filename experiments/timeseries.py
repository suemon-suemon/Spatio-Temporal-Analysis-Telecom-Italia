...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', help='baseline method', default='arima')
    ...
    in_len = 12
    pred_len = 1
    # Method:  arima MAE:  21.954545857833807  MAPE:  0.09289707549065185 RMSE:  42.39852055974731
    ...
    gt = rearrange(gt, 'b t g -> (b g) t')
    grid_pred = rearrange(grid_pred, 'b t g -> (b g) t')

    mae = mean_absolute_error(gt, grid_pred)
    mape = mean_absolute_percentage_error(gt, grid_pred)
    rmse = mean_squared_error(gt, grid_pred, squared=False)
