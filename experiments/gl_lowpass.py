...
if __name__ == '__main__':
    ...
    p = dict(
        ...
        log_run_name='GLLowPass_Temporal',
        log_project_name="GraphLearn",
        log_run_tag=["GLLowPass_Temporal"],
        time_now=timestamp,
    ...
    model = GLLowPass(
        num_nodes = dm.N_all,
        feature_size = p['close_len'],
        if_temporal_graph = p['if_temporal_graph'],
        show_fig=p['show_fig'],
